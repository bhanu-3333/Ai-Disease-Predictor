...
def report():
    try:
        ...
        # ---------------- TITLE ----------------
        elements.append(Paragraph("<b>MediScan AI Medical Report</b>", styles["Title"]))
        ...
        table.setStyle(TableStyle([
            ('BACKGROUND', (0,0), (-1,0), HexColor("#d4eefc")),
            ('GRID', (0,0), (-1,-1), 1, HexColor("#4aa3c4")),
            ('FONT', (0,0), (-1,0), 'Helvetica-Bold'),
            ('ALIGN', (0,0), (-1,0), 'CENTER'),
            ('BACKGROUND', (0,1), (0,-1), HexColor("#f1f9ff")),
        ]))
        ...
        elements.append(Paragraph(
            "<b>Disclaimer:</b> This report is generated by AI and is not a substitute for professional medical diagnosis. Please consult a qualified doctor before taking medication.",
            styles["Italic"]
        ))

        doc.build(elements)

        return send_file(file_path, as_attachment=True, download_name="Medical_Report.pdf")
